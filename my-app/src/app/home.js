...
const HomePageContent = () => {
  ...
  return (
      <div id="home" className="relative z-5 text-center text-white pt-[185px] pb-[163px]"> 
        ...
        {/* Resume button */}
        <a href='/Resume.pdf' id="bordermagic" className="no-underline relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
